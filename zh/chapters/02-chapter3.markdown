...
关于进程的相关操作请参考[《shell编程范例之进程操作》](http://www.tinylab.org/shell-programming-paradigm-of-process-operations/)。
